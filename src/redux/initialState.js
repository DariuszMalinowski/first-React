const initialState = {
  ...
  columns: [
    { id: 1, title: 'Books', icon: 'book', listId: 1 },
    { id: 2, title: 'Movies', icon: 'film', listId: 1 },
    { id: 3, title: 'Games', icon: 'gamepad', listId: 1 },
    { id: 4, title: 'Songs', icon: 'music', listId: 2 } // przykładowa kolumna dla drugiej listy
  ],
